...
const App = function () {
    ...
    const themeButtons = function() {
        const currentTheme = localStorage.getItem('theme');

        // Butonları seç
        const darkBtns = document.querySelectorAll('.btn-dark-theme');
        const lightBtns = document.querySelectorAll('.btn-light-theme');
        const autoBtns = document.querySelectorAll('.btn-auto-theme');

        // Sayfa yüklendiğinde aktif butonu işaretle
        const setActiveButton = (theme) => {
            ...
            if(theme === 'dark') darkBtns.forEach(btn => btn.classList.add('active'));
            else if(theme === 'light') lightBtns.forEach(btn => btn.classList.add('active'));
            else autoBtns.forEach(btn => btn.classList.add('active'));
        };
