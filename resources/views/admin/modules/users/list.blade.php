                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" data-popper-placement="top-start"
                                        ...
                                        <a href="#" class="dropdown-item text-danger"
                                           ...
                                           data-item-name="{{ $item->email }} user">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-12 col-sm-5 fw-semibold text-muted">{{ __('Username') }}:</div>
                        <div class="col-12 col-sm-7 text-sm-end" id="username">-</div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class="row mb-2">
                        <div class="col-12 col-sm-5 fw-semibold text-muted">{{ __('Role') }}:</div>
                        <div class="col-12 col-sm-7 text-sm-end" id="role">-</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-12 col-sm-5 fw-semibold text-muted">{{ __('Telegram') }}:</div>
                        <div class="col-12 col-sm-7 text-sm-end" id="telegram">-</div>
                    </div>
                    <div class="row mb-2">
