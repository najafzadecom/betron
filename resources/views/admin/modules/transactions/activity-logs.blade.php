        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    ...
                    ({{ $transaction->sender }} - {{ $transaction->currency->code() }} {{ number_format($transaction->amount, 2) }})
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-xs text-nowrap">
                            ...
                            <tr>
                                ...
                                <td>
                                    @can('activity-logs.show')
                                        <a href="#" class="btn btn-outline-success" data-url="{{ route('admin.activity-logs.show', $item->id) }}" data-bs-toggle="modal" data-bs-target="#show_modal">
                                            <i class="ph-eye me-1"></i> {{ __('Show activity log') }}
                                        </a>
                                    @endcan
                                </td>
                            </tr>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center">{{ __('No activity logs found for this transaction') }}</td>
                            </tr>
                        @endforelse
                        </tbody>
                    </table>
