                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input
                                type="text"
                                class="form-control"
                                value="{{ number_format($item->deposit_amount ?? 0, 2) }} ₺"
                                readonly
                                disabled
                            />
                            <div class="form-text text-muted">{{ __('Operational deposit balance (read-only, use deposit actions on the list).') }}</div>
                        </div>
                    </div>
                    @endif
