...
<head>
    ...
    <title>{{ env('APP_NAME') }} - {{ __('Vendor Login') }}</title>
    ...
    <div class="content-wrapper">
        <div class="content-inner">
            <div class="content d-flex justify-content-center align-items-center">
                <form class="login-form" method="POST" action="{{ route('vendor.auth.login') }}">
                    @csrf
                    <div class="card mb-0">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-control-feedback form-control-feedback-start input-group">
                                    ...
                                    >
                                         <i class="ph-eye" id="togglePassword"></i>
                                     </span>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
            ...
            <div class="navbar navbar-sm navbar-footer border-top">
                <div class="container-fluid">
                    <span>&copy; {{ date('Y') }} {{ env('APP_NAME') }} - {{ __('Vendor Portal') }}</span>
                </div>
            </div>
        </div>
    </div>
