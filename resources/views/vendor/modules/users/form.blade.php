                ...
                <form action="{{ $action }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                   placeholder="{{ __('E-mail') }}" value="{{ old('email', $item->email ?? '') }}" required/>
                            @error('email')
                            <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-9">
                            ...
                            @if(isset($item))
                                <small class="text-muted">{{ __('Leave blank if you do not want to change') }}</small>
                            @endif
                            @error('password')
                            <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                            @enderror
