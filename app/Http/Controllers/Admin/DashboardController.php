...
class DashboardController extends BaseController
{
    ...
    public function index(): Renderable
    {
        ...
        if ($merchantSiteId) {
            ...
            $this->statisticsService->createdFrom = Merchant::ALL_TIME_FROM;
            $this->statisticsService->createdTo = Merchant::defaultCreatedTo();
            ...
            $siteStatistics = $this->siteStatisticService->getBySiteId(Merchant::DEFAULT_SITE_ID);
            $site = $this->siteService->getById(Merchant::DEFAULT_SITE_ID);
        }
