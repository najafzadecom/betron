...
class WithdrawalController extends BaseController
{
    ...
    public function store(WithdrawalRequest $request): JsonResponse
    {
        ...
        try {
            ...
            $result = $this->formatWithdrawalData($withdrawal);
    ...
    public function byOrderId(Request $request, string $orderId): JsonResponse
    {
        $withdrawal = $this->withdrawalService->getByOrderIdAndSiteId(
            $orderId,
    ...
    private function formatWithdrawalData($withdrawal): array
    {
        return [
            'id' => $withdrawal->id,
